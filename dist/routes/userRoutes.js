...
import { requestLimiter, authenticateUser, customHeader, validateUser, queryValidation, getGeoLocation, dynamicValidation, } from "../middlewares/index.js";
...
router.get("/show/:id", customHeader({
